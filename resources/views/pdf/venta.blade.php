...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/favicon.png" alt="CompartiendoCodigo" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>UCIMEX</b><br>Avenida A #22 Sto. Do. Este<br>Telefono:809-231-818<br>Email: compartiendocodigos@gmail.com
                </p>
            </div>
            <div id="fact">
